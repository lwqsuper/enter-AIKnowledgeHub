...
import { ragTutorials } from "@/data/content";
            ...
            >
              <CardContent className="pt-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <Badge className={levelColors[topic.difficulty]}>{topic.difficulty}</Badge>
                </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-block glass-card rounded-2xl p-8 glow-primary">
            ...
            <Button 
              ...
              onClick={() => navigate("/detail/rag/vector-db")}
            >
              立即开始
